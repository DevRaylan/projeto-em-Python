...
class SistemaAcademicoApp:
    def __init__(self, root):
        ...
        # Botão para escolher onde salvar o arquivo
        self.botao_salvar = tk.Button(self.root, text="Escolher Local para Salvar", command=self.escolher_local_arquivo)
    ...
    def escolher_local_arquivo(self):
        ...
        if caminho:
            ...
            messagebox.showinfo("Caminho escolhido", f"Os dados serão salvos em: {self.caminho_arquivo}")
